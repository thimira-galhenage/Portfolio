  ...
  theme: {
    extend: {
      ...
      animation: {
       ...
       backgroundImage:{
        circularLight:'repeating-radial-gradient(rgba(0,0,0,0.4), #f5f5f5 7px, #f5f5f5 100px);',
        circularDark:'repeating-radial-gradient(rgba(255,255,255,0.6), #1b1b1b 8px, #1b1b1b 100px);',
        circularLightLg:'repeating-radial-gradient(rgba(0,0,0,0.4), #f5f5f5 7px, #f5f5f5 80px);',
        circularDarkLg:'repeating-radial-gradient(rgba(255,255,255,0.6), #1b1b1b 8px, #1b1b1b 80px);',
